...
(ref:figure1) Location of the boundaries of the five spatial areas (S~1~-S~5~) of the `r yr` stratified random survey design. The three depths strata (RD~1~-RD~3~) are colour-coded and nested within each of the five spatial strata. 
...
(ref:figure3)  Image of the F/V `r boat`  used for the `r yr` sablefish research and assessment survey. 
...
```{r figure14, fig.cap='(ref:figure14)', results='asis', out.width = "480px",out.height = "616px", fig.align = "center"}
...
(ref:figure15) Location of the epicentre of a 7.7 magnitude earthquake on Saturday October 27, 2012 at 8:04 p.m.  The inset shows the accelerometer reading that captured the earthquake event..

```{r figure15, fig.cap='(ref:figure15)', out.width = "470px", out.height = "363px",echo=FALSE, fig.align="center", warning=FALSE}
